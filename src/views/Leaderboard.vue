    ...
    <div class="leaderboard-timer">
      <div class="timer-inner">
        ...
        <div class="inner-value">
          <span>{{ leaderboardTimer.split(':')[0] }}</span
          >d <span>{{ leaderboardTimer.split(':')[1] }}</span
          >h <span>{{ leaderboardTimer.split(':')[2] }}</span
          >m <span>{{ leaderboardTimer.split(':')[3] }}</span
          >s
        </div>
      </div>
    </div>
        ...
        <transition name="fade" mode="out-in">
          ...
          <div v-else-if="leaderboardData.data !== null" class="content-list" key="data">
            <LeaderboardUserElement
              v-for="(winner, index) of leaderboardData.data.winners"
              v-bind:key="index"
...
import LeaderboardUserElement from '@/components/leaderboard/LeaderboardUserElement.vue'
