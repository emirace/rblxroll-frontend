...
const state = {
  ...
  socketGeneral: socketIo(import.meta.env.VITE_VUE_APP_SOCKET_URL + '/general', {
    auth: {},
    autoConnect: false,
    reconnection: true,
  ...
  socketCrash: socketIo(import.meta.env.VITE_VUE_APP_SOCKET_URL + '/crash', {
    auth: {},
    autoConnect: false,
    reconnection: true,
    reconnectionDelay: 5000,
  ...
  socketRoll: socketIo(import.meta.env.VITE_VUE_APP_SOCKET_URL + '/roll', {
    auth: {},
    autoConnect: false,
    reconnection: true,
    reconnectionDelay: 5000,
  ...
  socketBlackjack: socketIo(import.meta.env.VITE_VUE_APP_SOCKET_URL + '/blackjack', {
    auth: {},
    autoConnect: false,
    reconnection: true,
    reconnectionDelay: 5000,
  ...
  socketDuels: socketIo(import.meta.env.VITE_VUE_APP_SOCKET_URL + '/duels', {
    auth: {},
    autoConnect: false,
    reconnection: true,
    reconnectionDelay: 5000,
  ...
  socketMines: socketIo(import.meta.env.VITE_VUE_APP_SOCKET_URL + '/mines', {
    auth: {},
    autoConnect: false,
    reconnection: true,
    reconnectionDelay: 5000,
  ...
  socketTowers: socketIo(import.meta.env.VITE_VUE_APP_SOCKET_URL + '/towers', {
    auth: {},
    autoConnect: false,
    reconnection: true,
    reconnectionDelay: 5000,
  ...
  socketUnbox: socketIo(import.meta.env.VITE_VUE_APP_SOCKET_URL + '/unbox', {
    auth: {},
    autoConnect: false,
    reconnection: true,
    reconnectionDelay: 5000,
  ...
  socketBattles: socketIo(import.meta.env.VITE_VUE_APP_SOCKET_URL + '/battles', {
    auth: {},
    autoConnect: false,
    reconnection: true,
    reconnectionDelay: 5000,
  ...
  socketUpgrader: socketIo(import.meta.env.VITE_VUE_APP_SOCKET_URL + '/upgrader', {
    auth: {},
    autoConnect: false,
    reconnection: true,
    reconnectionDelay: 5000,
  ...
  socketCashier: socketIo(import.meta.env.VITE_VUE_APP_SOCKET_URL + '/cashier', {
    auth: {},
    autoConnect: false,
    reconnection: true,
    reconnectionDelay: 5000,
  ...
  socketAdmin: socketIo(import.meta.env.VITE_VUE_APP_SOCKET_URL + '/admin', {
    auth: {},
    autoConnect: false,
    reconnection: true,
    reconnectionDelay: 5000,
