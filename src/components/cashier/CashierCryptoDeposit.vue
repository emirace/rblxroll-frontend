  ...
  <div class="cashier-crypto-deposit">
    <div class="deposit-info">
      ...
      <div class="info-text">
        ...
        <p>
          Always double-check the address and the amount before sending. We cannot recover funds
          sent to the wrong address.The final amount is calculated once your deposit confirms on the
          network.
        </p>
        <p>
